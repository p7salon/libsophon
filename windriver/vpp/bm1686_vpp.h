...
/*vpp global control*/
#define BM1686_VPP_VERSION           (0x100)
#define BM1686_VPP_CONTROL0          (0x110)
#define BM1686_VPP_CMD_BASE          (0x114)
#define BM1686_VPP_CMD_BASE_EXT      (0x118)
#define BM1686_VPP_STATUS            (0x11C)
#define BM1686_VPP_INT_EN            (0x120)
#define BM1686_VPP_INT_CLEAR         (0x124)
#define BM1686_VPP_INT_STATUS        (0x128)
#define BM1686_VPP_INT_RAW_STATUS    (0x12c)
