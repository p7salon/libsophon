...
/*vpp global control*/
#define BM1684_VPP_VERSION          (0x000)
#define BM1684_VPP_CONTROL0         (0x004)
#define BM1684_VPP_CONTROL1         (0x008)
#define BM1684_VPP_STATUS           (0x00C)
#define BM1684_VPP_INT_EN           (0x010)
#define BM1684_VPP_INT_CLEAR        (0x014)
#define BM1684_VPP_INT_STATUS       (0x018)
#define BM1684_VPP_INT_RAW_STATUS   (0x01c)
#define BM1684_VPP_CMD_BASE         (0x020)
#define BM1684_VPP_CMD_BASE_EXT     (0x024)
#define MAP_CONV_TIMEOUT_CNT (0x028)
...
#define MAP_CONV_OFF_BASE_Y    (0x0308)
#define MAP_CONV_OFF_BASE_C    (0x030c)
...
#define MAP_CONV_OFF_STRIDE    (0x0344)
