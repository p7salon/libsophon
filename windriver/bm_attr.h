...
int bm_burning_info_sn(struct bm_device_info *, _In_ WDFREQUEST Request);
int bm_burning_info_mac(struct bm_device_info *, int id, _In_ WDFREQUEST Request);
int bm_burning_info_board_type(struct bm_device_info *, _In_ WDFREQUEST Request);
